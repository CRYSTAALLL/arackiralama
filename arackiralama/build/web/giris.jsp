...
<body>
    ...
    %>
    <nav class="area" >
        <a href="#first">ARAC KIRALA</a>
        <a href="#second">KIRALANAN ARACLAR</a>
        <a href="#third">PROFIL</a>
    </nav>
    
    <%!
       public String [] marka = new String[3];
       public String [] model = new String[3];
       public String [] fiyat = new String[3];
       public String [] yil = new String[3]; 
...
while(r.next()){
    ...
    out.print("</div>");
        ...
        <div class = "card-container"> 
            ...
            <input class="btn_son" style="margin-top: 400px; margin-left: 140px;" type="submit" value="ANA MENU" name="anamenu" />
        </form> 
    </div>
                   ...
                   out.println("<P class='fiyatt'>"+ fiyat[aracbilgisi]+ "</p>");
                    ...
                    <%
                        ...
                        if(s !=null){
                            ...
                            out.println("<P class='text'>ARAC KIRALAMA BASARILI</p>");
                        }
                        %>
