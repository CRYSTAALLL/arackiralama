...
if(cookies != null){
    //mail degeri cookieden al?n?yor ve de?i?kene atan?yor
    ...
    %>
     <p class="hg">Hosgeldin : <%= epostaa %></p>
    <nav class="area" >
        <a href="#first">ARAC EKLE</a>
        <a href="#second">ARAC LISTELE</a>
        <a href="#third">PROFIL</a>
        <a href="#fourth">KULLANICILAR</a>
    </nav>
